# Story Outcomes — Canon Endings

Locked decisions for national team, epilogue, character arcs, and combat mechanics.  
**Cross-check:** scripts Ch 94–110 (Arc 7) · Ch 111–120 (Arc 8) · [arc-07-legends.md](./arcs/arc-07-legends.md) reading order.

---

## Grandmother — Death & Berserker Rage

### Timeline
| When | Event |
|------|-------|
| Arc 1 Ch 8 | Hospital visits — declining health |
| Arc 4 Ch 45 | Weaker — Ethan brings ribbon, not trophy |
...
### Berserker Rage (Post-Death Trigger)

**Activates when:** Hard training push **or** critical hit (head shot, knockdown, grief flash).

**Effects:** Faster/stronger kicks · speed up · **defense down** · red tint · reckless pressure.

**Growth arc:** Arc 7 loss = read the spin, lose the war on **points**. Arc 8 win = **control** over explosion.

---

## Korea U20 — Final Results (Arc 7 · Ch 94–110)

| Ch | Character | Exit | Score / rule | Script |
|----|-----------|------|--------------|--------|
...
**Only TJ makes national team.** Ethan falls short — not broken.

### Arc 7 Camp Signatures (Ch 91–93)
...
## Epilogue (Arc 8 · Ch 116–120)

| Ch | Beat | Lock |
|----|------|------|
| **116** | Yuna **friendship ring** · matching bands · *Yellow only. Still.* | [ch116-120](./scripts/arc-08-ch116-120-epilogue.md) |
| **117** | Six-path montage · **SNU campus** · *school AND taekwondo* payoff | *(same)* |
| **118** | vs **Park Sung-min** · collegiate **WIN** · rage declined · Yuna nod | *(same)* · [park-sung-min.md](./characters/park-sung-min.md) |
| **119** | MV: *Character, not rank* · scoreboard → wood grain | *(same)* |
| **120** | Team photo · memorial photo callback · **TAEKWONDO LEGENDS** | *(same)* |

| Character | Next step |
|-----------|-----------|
| **Ethan** | **SNU** + **collegiate champion** (Ch 118) — proves school **and** taekwondo |
| **TJ** | National team · coaches kids at Kwon's |
| **Kian** | Next cycle — *Quarters won't happen twice* |
| **Kieryn** | Semifinal fuel — *Preview, not ceiling* |
| **Ariana** | Sport for herself — father hug |
| **Logan** | Corner forever · Ch 100 *It counts* |
| **Yuna** | Friendship ring · quiet stands · implied college dating |

---

## Real Line Payoff

**Arc 4 parent (REAL #1):** *"You want him to be good at school AND Taekwondo?"*

**Answer (Ch 117–118, never to Ttong Kim's face):** SNU admission + collegiate gold.
...
## Yuna Park — Romance Pace

- Arc 3 vending seed → Arc 7 Ch **108** Fanta → Ch **116** friendship ring
- Not engagement · cheers Ch **118** collegiate final · quiet nod
- See [yuna-park.md](./characters/yuna-park.md) · [short-yuna-pineapple-fanta.md](./scripts/short-yuna-pineapple-fanta.md)
...
*Last synced: Arc 7 sequential 91–110 · Logan Ch 100 rewrite · Arc 8 panel storyboard §111–120*
