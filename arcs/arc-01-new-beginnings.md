...
Ethan arrives alone at Kwon's Taekwondo Academy — quiet, guarded, carrying a silver-letter black belt no one else has. He watches Master Viet coach a student with patience he's never seen. A nightmare opens the story; hope closes it: *"Welcome to Kwon's."*
...
- Gold headphones on nightstand — dawn light through curtains
- Hand still raised like blocking a kick that isn't there
- **Tone:** Horror-adjacent sports trauma — the neglect is the nightmare as much as the head shot

#### Storyboard Notes for AI
- **Palette:** sickly venue fluorescents, grey bleachers, desaturated crowd
- **Contrast key:** paying families = warm instructor proximity; Ethan = wide empty space around him on bleachers
- **Clock motif:** wall clock or phone time stamps (7:04 AM → 2:47 PM → 3:12 PM fight) to sell the wait
- **No Kwon's yet** — save warm amber palette for Chapter 2
...
| Event | Chapter |
|-------|---------|
| All-day wait, no warmup, paid coaching / minutes of attention | 1 |
| "Go fight." — only corner advice | 1 |
| MV individual coaching contrast | 2 |
| Perfect form compliment | 4 |
| Korea U20 goal | 5 |
| Favoritism flashback (seed) | 7 |
| Hospital + threatening messages | 8 |
...
- Each new member needs a "why I left" story
- Olympic sparring rules must be taught before first tournament
- Team chemistry scene (baseline banter) not yet performed as full group
...
**Sport education panels `[TEACH]`:** Ch 4 kicks · See [OLYMPIC-TKD-EDUCATION.md](../OLYMPIC-TKD-EDUCATION.md)
